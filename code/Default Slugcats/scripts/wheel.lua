...
function pings.slugcat(scugType)
	...
	slugcatUpperBody.head.Main:setPrimaryTexture("CUSTOM",textures["textures."..scug])
	slugcatUpperBody.Body.Main:setPrimaryTexture("CUSTOM",textures["textures."..scug])
	slugcatUpperBody.Body.Tail1.Main:setPrimaryTexture("CUSTOM",textures["textures."..scug])
	slugcatUpperBody.Body.Tail1.Tail2.Main:setPrimaryTexture("CUSTOM",textures["textures."..scug])
	slugcatUpperBody.Body.Tail1.Tail2.Tail3:setPrimaryTexture("CUSTOM",textures["textures."..scug])
	slugcatUpperBody.Arms.LeftArm.Main:setPrimaryTexture("CUSTOM",textures["textures."..scug])
	slugcatUpperBody.Arms.RightArm.Main:setPrimaryTexture("CUSTOM",textures["textures."..scug])
	slugcatLowerBody.LeftLeg.Main:setPrimaryTexture("CUSTOM",textures["textures."..scug])
	slugcatLowerBody.RightLeg.Main:setPrimaryTexture("CUSTOM",textures["textures."..scug])
	slugcat.FullBody.AscensionMark:setPrimaryTexture("CUSTOM",textures["textures."..scug])
	slugcat.FullBody.ComMark:setPrimaryTexture("CUSTOM",textures["textures."..scug])

	slugcatUpperBody.head.Main:setSecondaryTexture("CUSTOM",textures["textures."..scug.."_e"])
	slugcatUpperBody.Body.Main:setSecondaryTexture("CUSTOM",textures["textures."..scug.."_e"])
	slugcatUpperBody.Body.Tail1.Main:setSecondaryTexture("CUSTOM",textures["textures."..scug.."_e"])
	slugcatUpperBody.Body.Tail1.Tail2.Main:setSecondaryTexture("CUSTOM",textures["textures."..scug.."_e"])
	slugcatUpperBody.Body.Tail1.Tail2.Tail3:setSecondaryTexture("CUSTOM",textures["textures."..scug.."_e"])
	slugcatUpperBody.Arms.LeftArm.Main:setSecondaryTexture("CUSTOM",textures["textures."..scug.."_e"])
	slugcatUpperBody.Arms.RightArm.Main:setSecondaryTexture("CUSTOM",textures["textures."..scug.."_e"])
	slugcatLowerBody.LeftLeg.Main:setSecondaryTexture("CUSTOM",textures["textures."..scug.."_e"])
	slugcatLowerBody.RightLeg.Main:setSecondaryTexture("CUSTOM",textures["textures."..scug.."_e"])
	slugcat.FullBody.AscensionMark:setSecondaryTexture("CUSTOM",textures["textures."..scug.."_e"])
	slugcat.FullBody.ComMark:setSecondaryTexture("CUSTOM",textures["textures."..scug.."_e"])
