...
menu:newAction()
	:title("Base Slugcats")
	:texture(textures["textures.icons"], 0, 0, 32, 32)
...
menu:newAction()
	:title("Toggles")
	:texture(textures["textures.icons"], 0, 96, 32, 32)
	:onLeftClick(function()
		prevPage = action_wheel:getCurrentPage()
...
base:newAction()
	:title("Back")
	:texture(textures["textures.icons"], 64, 64, 32, 32)
    :onLeftClick(function()
...
base:newAction()
    :title("Monk")
	:texture(textures["textures.icons"], 32, 0, 32, 32)
	:onLeftClick(function() pings.slugcat("monk") end)
	:setColor(vectors.hexToRGB("#999999"))
	:setHoverColor(vectors.hexToRGB("#ffffff"))
base:newAction()
	:title("Hunter")
	:texture(textures["textures.icons"], 64, 0, 32, 32)
	:onLeftClick(function() pings.slugcat("hunter") end)
	:setColor(vectors.hexToRGB("#999999"))
	:setHoverColor(vectors.hexToRGB("#ffffff"))
base:newAction()
	:title("Nightcat")
	:texture(textures["textures.icons"], 96, 0, 32, 32)
	:onLeftClick(function() pings.slugcat("nightcat") end)
	:setColor(vectors.hexToRGB("#999999"))
	:setHoverColor(vectors.hexToRGB("#ffffff"))
base:newAction()
	:title("Artificer")
	:texture(textures["textures.icons"], 0, 32, 32, 32)
	:onLeftClick(function() pings.slugcat("artificer") end)
	:setColor(vectors.hexToRGB("#999999"))
	:setHoverColor(vectors.hexToRGB("#ffffff"))
base:newAction()
    :title("Gourmand")
	:texture(textures["textures.icons"], 32, 32, 32, 32)
	:onLeftClick(function() pings.slugcat("gourmand") end)
	:setColor(vectors.hexToRGB("#999999"))
	:setHoverColor(vectors.hexToRGB("#ffffff"))
base:newAction()
    :title("Rivulet")
	:texture(textures["textures.icons"], 64, 32, 32, 32)
...
base:newAction()
    :title("Spearmaster")
	:texture(textures["textures.icons"], 96, 32, 32, 32)
	:onLeftClick(function() pings.slugcat("spearmaster") end)
	:setColor(vectors.hexToRGB("#999999"))
	:setHoverColor(vectors.hexToRGB("#ffffff"))
base:newAction()
    :title("Saint")
	:texture(textures["textures.icons"], 0, 64, 32, 32)
	:onLeftClick(function() pings.slugcat("saint") end)
	:setColor(vectors.hexToRGB("#999999"))
	:setHoverColor(vectors.hexToRGB("#ffffff"))
base:newAction()
	:title("[SPOILER] Saint")
	:texture(textures["textures.icons"], 32, 64, 32, 32)
...
toggles:newAction()
    :title("Size")
	:texture(textures["textures.icons"], 64, 96, 32, 32)
	:toggled(false)
	:onToggle(pings.size)
	:setColor(vectors.hexToRGB("#2c43b7"))
	:setHoverColor(vectors.hexToRGB("#95a1db"))
...
toggles:newAction()
	:title("Eye Height")
	:texture(textures["textures.icons"], 128, 0, 32, 32)
	:toggled(false)
...
toggles:newAction()
	:title("Saint Tongue")
	:texture(textures["textures.icons"], 96, 96, 32, 32)
	:toggled(false)
...
toggles:newAction()
	:title("[SPOILER] Mark")
	:texture(textures["textures.icons"], 96, 64, 32, 32)
	:toggled(false)
...
toggles:newAction()
    :title("Hide Gun")
	:texture(textures["textures.icons"], 128, 32, 32, 32)
	:toggled(false)
