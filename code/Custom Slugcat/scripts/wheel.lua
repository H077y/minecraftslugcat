...
menu:newAction()
	...
	:texture(textures["textures.icons"], 32, 96, 32, 32)
...
custom:newAction()
	:title("Colours")
	:texture(textures["textures.icons"], 160, 96, 32, 32)
	:onLeftClick(function() action_wheel:setPage(colour) end)
	:setColor(vectors.hexToRGB("#f691ff"))
	:setHoverColor(vectors.hexToRGB("#fac8ff"))
custom:newAction()
	:title("Eyes")
	:texture(textures["textures.icons"], 128, 64, 32, 32)
	:onLeftClick(function() action_wheel:setPage(eyes) end)
	:setColor(vectors.hexToRGB("#f691ff"))
	:setHoverColor(vectors.hexToRGB("#fac8ff"))
custom:newAction()
	:title("Shape")
	:texture(textures["textures.icons"], 128, 96, 32, 32)
	:onLeftClick(function() action_wheel:setPage(shape) end)
	:setColor(vectors.hexToRGB("#f691ff"))
	:setHoverColor(vectors.hexToRGB("#fac8ff"))
custom:newAction()
	:title("Feature")
	:texture(textures["textures.icons"], 160, 32, 32, 32)
	:onLeftClick(function() action_wheel:setPage(feature) end)
	:setColor(vectors.hexToRGB("#f691ff"))
	:setHoverColor(vectors.hexToRGB("#fac8ff"))
custom:newAction()
	:title("Spear")
	:texture(textures["textures.icons"], 160, 0, 32, 32)
...
pings.setColor = function (color,picker)
	if picker == "primary" then
		...
		slugcatUpperBody.head.Main.Eyes.Artificer.Scar:setColor(color)
...
colour:newAction()
	...
	:texture(textures["textures.icons"], 160, 64, 32, 32)
